package com.elderly.aid.common;
...
public class SqlserverGenerator {
    ...
    //基础包名
    private static String basePackage="com.elderly.aid.sys";
    //设置作者
    private static String authorName="xuyuankai";
    ...
    private static String url = "jdbc:sqlserver://122.112.211.34:11433;DatabaseName=AqyDatabase";
    private static String username = "sa";
    private static String password = "zhy1@zya";
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.elderly.aid.sys");
        pc.setEntity("entity");
